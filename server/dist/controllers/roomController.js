...
exports.roomCheck = (0, catchAsync_1.catchAsync)(async (req, res, next) => {
    ...
    let statusCode = 200;
    room = await Room_1.default.findOne({ users: [(_b = req.user) === null || _b === void 0 ? void 0 : _b.id, req.params.id] });
    if (!room) {
        room = await Room_1.default.create({
            users: [(_c = req.user) === null || _c === void 0 ? void 0 : _c.id, req.params.id],
        });
        statusCode = 201;
    }
